...
form.addEventListener('submit', (e) =>{
    ...
    nameVal.addEventListener('input', (e)=>{
        ...
        numberVal.addEventListener('input', (e) =>{
            number.textContent = numberVal.value
            export default first.addEventListener('input', (e) =>{
                number.textContent = export default first.value
            })
        })
    })
    processing()
