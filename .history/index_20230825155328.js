...
if(forms){
    forms.addEventListener('input', async (e)=>{
        ...
        forms.addEventListener('submit', async () => {
            ...
            } catch (error/* The `) ` is closing the argument list for the `addEventListener` function.
            It is used to specify the event type and the callback function that should
