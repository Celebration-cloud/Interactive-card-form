    ...
    forms.addEventListener('input', async (e)=>{
        try {
            ...
            forms.addEventListener('submit', async (e) => {
                ...
                try {
                    form.render()
                    await fetch(`https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/${appID}`)
                    const response = await fetch(`https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/${appID}/cards`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        }
                    }
                    if(!nameVal || !numberVal||!monthVal||!yearVal||!cvcVal ){
